...
#
# Script generated by Vivado on Mon Dec 11 10:14:15 -0500 2023
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : full_adder.sh
...
#
# Usage        : full_adder.sh
#                full_adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                full_adder.sh [-reset_run]
#                full_adder.sh [-reset_log]
#                full_adder.sh [-help]
#
...
# script info
echo -e "full_adder.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./full_adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot full_adder xil_defaultlib.full_adder xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim full_adder -key {Behavioral:sim_1:Functional:full_adder} -tclbatch cmd.tcl -protoinst "protoinst_files/full_adder.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb full_adder.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./full_adder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: full_adder.sh [-help]\n\
Usage: full_adder.sh [-step]\n\
Usage: full_adder.sh [-lib_map_path]\n\
Usage: full_adder.sh [-reset_run]\n\
Usage: full_adder.sh [-reset_log]\n\
Usage: full_adder.sh [-keep_index]\n\
Usage: full_adder.sh [-noclean_files]\n\n\
